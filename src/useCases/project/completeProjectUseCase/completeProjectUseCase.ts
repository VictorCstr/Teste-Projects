import { ICompleteProjectDTO } from "./completeProjectDTO";
...
export class CompleteProjectUseCase {
  ...
  async execute(data: ICompleteProjectDTO): Promise<Project> {
    ...
    return await this.projectRepository.completeProject(username, projectId);
  }
}
